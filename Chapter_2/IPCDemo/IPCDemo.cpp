...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	BOOL bSuccess = CreateProcess( TEXT("..\\x64\\Debug\\IPCWorker.exe"), TEXT("red"), NULL, NULL, FALSE, 0, NULL, NULL, &startupInfoRed, &processInformationRed);
	if (!bSuccess)
	{
		cout << "Cannot create process red!" << endl << "Error:\t" << GetLastError() << endl;
		return 1;
	}
	bSuccess = CreateProcess( TEXT("..\\x64\\Debug\\IPCWorker.exe"), TEXT("blue"), NULL, NULL, FALSE, 0, NULL, NULL, &startupInfoBlue, &processInformationBlue);
	if (!bSuccess)
	{
